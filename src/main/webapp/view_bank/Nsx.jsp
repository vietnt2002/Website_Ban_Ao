    ...
    <form action="addNsx" method=post>
        <div class="card bg-light text-white" style="height: 900px">
            <div class="card-img-overlay">
                <h5 class="card-title" style="color:darkblue; text-align: center; font-size: 36px;">Nơi sản xuất
                </h5>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="#idSystem"
                                           aria-label="Username" aria-describedby="basic-addon1" name="idInp" value = "${nsx.idNSX}" readonly>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                <label class="gfield_label fw-semibold" style="color:#374151;font-size: 14px;"
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="Tên"
                                           aria-label="Username" aria-describedby="basic-addon1" name="maInp" value = "${nsx.ma}">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                <label class="gfield_label fw-semibold" style="color:#374151;font-size: 14px;"
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="Tên"
                                           aria-label="Username" aria-describedby="basic-addon1" name="tenInp" value ="${nsx.ten}">
                                </div>
                            </div>
                            ...
                            <table class="table mt-5">
                                ...
                                <c:forEach varStatus="i" items="${lstNsx}" var="nsx">
                                    <tr>
                                        ...
                                        <td>${nsx.ten}</td>
                                        <td>
                                            <a href="/Home/detail-nsx?id=${nsx.idNSX}">
                                                <button type="button" class="btn btn-primary">Detail</button>
                                            </a>
                                            <a href="/Home/routeUpdate-nsx?id=${nsx.idNSX}">
                                                <button type="button" class="btn btn-success ">Update</button>
                                            </a>
                                            <a href="/Home/delete-nsx?id=${nsx.idNSX}">
