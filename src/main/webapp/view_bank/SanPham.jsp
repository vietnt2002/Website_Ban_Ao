    ...
    <form action="addSanPham" method=post>
        <div class="card bg-light text-white" style="height: 900px">
            <div class="card-img-overlay">
                <h5 class="card-title" style="color:darkblue; text-align: center; font-size: 36px;">Them mau sac
                </h5>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="#idSystem"
                                           aria-label="Username" aria-describedby="basic-addon1" name="idInp" value = "${sanPham.id}" readonly>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                <label class="gfield_label fw-semibold" style="color:#374151;font-size: 14px;"
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="Tên"
                                           aria-label="Username" aria-describedby="basic-addon1" name="ma" value = "${sanPham.ma}">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                <label class="gfield_label fw-semibold" style="color:#374151;font-size: 14px;"
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="Tên"
                                           aria-label="Username" aria-describedby="basic-addon1" name="ten" value ="${sanPham.ten}">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                <label class="gfield_label fw-semibold" style="color:#374151;font-size: 14px;"
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="Tên"
                                           aria-label="Username" aria-describedby="basic-addon1" name="link" value ="${sanPham.link}">
                                </div>
                            </div>
...
<%--                                        <td>${sanPham.link}</td>--%>
<%--                                        <td>--%>
<%--                                            <a href="/Home/detail-SanPham?id=${sanPham.ma}">--%>
<%--                                                <button type="button" class="btn btn-primary">Detail</button>--%>
<%--                                            </a>--%>
<%--                                            <a href="/Home/routeUpdate-SanPham?id=${sanPham.ma}">--%>
<%--                                                <button type="button" class="btn btn-success ">Update</button>--%>
<%--                                            </a>--%>
<%--                                            <a href="/Home/delete-SanPham?id=${sanPham.ma}">--%>
