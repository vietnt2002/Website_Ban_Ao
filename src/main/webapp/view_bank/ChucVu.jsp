...
<main>
    <form action="addChucVu" method=post>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="#idSystem"
                                           aria-label="Username" aria-describedby="basic-addon1" name="idInp" value = "${chucVu.id}" readonly>
                                </div>
                            </div>
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                <label class="gfield_label fw-semibold" style="color:#374151;font-size: 14px;"
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="Tên"
                                           aria-label="Username" aria-describedby="basic-addon1" name="maInp" value = "${chucVu.ma}">
                                </div>
                            </div>
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                <label class="gfield_label fw-semibold" style="color:#374151;font-size: 14px;"
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" placeholder="Tên"
                                           aria-label="Username" aria-describedby="basic-addon1" name="tenInp" value ="${chucVu.ten}">
                                </div>
                            </div>
                            <div class="text-center ">
                                <br><br><br>
                                <button type="submit" class="btn btn-primary" style="border-radius:0%;">Thêm chức vụ
                                </button>
                            </div>
                            <table class="table mt-5">
                                ...
                                <c:forEach varStatus="i" items="${lstChucVu}" var="chucVu">
                                    <tr>
                                        <td>1</td>
                                        <td>${chucVu.idChucVu}</td>
                                        <td>${chucVu.ma}</td>
                                        <td>${chucVu.ten}</td>
                                        <td>
                                            <a href="/Home/detail-ChucVu?id=${chucVu.idChucVu}">
                                                <button type="button" class="btn btn-primary">Detail</button>
                                            </a>
                                            <a href="/Home/update-ChucVu?id=${chucVu.idChucVu}">
                                                <button type="button" class="btn btn-success ">Update</button>
                                            </a>
                                            <a href="/Home/delete-ChucVu?id=${chucVu.idChucVu}">
