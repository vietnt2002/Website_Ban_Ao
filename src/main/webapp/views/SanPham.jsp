    ...
    <form action="addSanPham" method=post>
        <div class="card bg-light text-white" style="height: 900px">
            <div class="card-img-overlay">
                <h5 class="card-title" style="color:darkblue; text-align: center; font-size: 36px;">Quản lý sản phẩm
                </h5>
                            ...
                            <table class="table mt-5">
                                ...
                                <c:forEach varStatus="i" items="${lstSanPham}" var="sanPham">
                                    <tr>
                                        ...
                                        <td>${sanPham.ten}</td>
                                        <td>
                                            <a href="/Home/detail-SanPham?id=${sanPham.idSanPham}">
                                                <button type="button" class="btn btn-primary">Detail</button>
                                            </a>
                                            <a href="/Home/routeUpdate-SanPham?id=${sanPham.idSanPham}">
                                                <button type="button" class="btn btn-success ">Update</button>
                                            </a>
                                            <a href="/Home/delete-SanPham?id=${sanPham.idSanPham}">
