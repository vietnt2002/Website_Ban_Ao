                ...
                <div class="container">
                    ...
                    <div class="row mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form method="post" action="/store/tim-kiem">
                                    <div class="row mb-2">
                                        <div class="col-6">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="/store/quan-ly-nhan-vien"><button type="button" class="btn btn-secondary">Làm mới bộ lọc</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="/store/them-nhan-vien-view"><button class="btn btn-primary float-end">+ Thêm</button></a>
                            </div>
                            <div class="card-body">
                                <table class="table" id="nhanVienTable">
                                    ...
                                    <c:forEach varStatus="i" items="${listNhanVien}" var="nv">
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/store/sua-trang-thai/${nv.id}"><button class="btn btn-outline-secondary" style="width: 33px; display: inline-flex;align-items: center;justify-content: center"><i class="bi bi-arrow-repeat" style="font-size: 17px"></i></button></a>
                                                <a href="/store/sua-nhan-vien-view/${nv.id}"><button class="btn btn-warning"><i class="bi bi-pencil-square"></i></button></a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
