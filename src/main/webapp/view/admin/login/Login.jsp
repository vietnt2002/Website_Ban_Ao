...
<main>
    <sf:form action="enter" method="post" modelAttribute="data">
                    ...
                    <div class="row">
                        <div class="col-lg-12 md-12 mt-3">
                            <div class="input-group flex-nowrap">
                                <sf:input type="text" class="form-control" placeholder="Account" aria-label="Username"
                                       aria-describedby="addon-wrapping" name="email" path="email"/>
                            </div>
                        </div>
                        <div class="col-lg-12 md-12 mt-3">
                            <div class="input-group flex-nowrap">
                                <sf:input type="password" class="form-control" placeholder="Password" aria-label="Username"
                                       aria-describedby="addon-wrapping" name="password" path="password"/>
                            </div>
                        </div>
                        <br><br><br><br>
