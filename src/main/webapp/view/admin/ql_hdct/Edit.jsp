...
<main>
    <sf:form action="/hdct/update/${data.id}" method="POST" modelAttribute="data">
        <div class="card bg-light text-white" style="height: 900px">
            <div class="card-img-overlay">
                <h5 class="card-title" style="color:darkblue; text-align: center; font-size: 36px;">Hóa đơn chi tiết
                </h5>
                    ...
                    <div class="form bg-white m-auto" style="color:black;width:1280px;padding:56px;">
                        <div class="row">
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                >Hóa đơn </label>
                                <div class="input-group mb-2">
                                    <select class="form-select" id="inputGroupSelect02" name="idHoaDon"
                                            path="idHoaDon">
                                        <c:forEach varStatus="i" items="${dsHoaDon}" var="hoaDon">
                                            <option value=${hoaDon.id} <c:if test="${data.idHoaDon == hoaDon.id }">selected</c:if>>${hoaDon.khachHang.ten} - ${hoaDon.id}</option>
                                        </c:forEach>
                                    </select>
                                    <sf:errors path="idHoaDon" cssStyle="color: red"/>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                >SPCT</label>
                                <div class="input-group mb-2">
                                    <select class="form-select" id="inputGroupSelect02" name="idSPCT"
                                            path="idSPCT">
                                        <c:forEach varStatus="i" items="${dsSPCT}" var="spct">
                                            <option value=${spct.id} <c:if test="${data.idSPCT == spct.id }">selected</c:if>>${spct.sanPham.ten}-${spct.mauSac.ten}/${spct.mauSac.ma
                                                    }-${spct.kichThuoc.ten}/${spct.kichThuoc.ma}</option>
                                        </c:forEach>
                                    </select>
                                    <sf:errors path="idSPCT" cssStyle="color: red"/>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                >Số lượng</label>
                                <div class="input-group mb-2">
                                    <sf:input type="number" class="form-control" placeholder="Số lượng"
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                >Đơn giá</label>
                                <div class="input-group mb-2">
                                    <sf:input type="number" class="form-control" placeholder="donGia"
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                >Ngày mua hàng</label>
                                <div class="input-group mb-2">
                                    <input type="date" class="form-control" placeholder="ngayMuaHang"
                                           aria-label="Username" aria-describedby="basic-addon1" value="${ngayMuaHang}" name="ngayMuaHang"/>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                >Thời gian</label>
                                <div class="input-group mb-2">
                                    <input type="time" class="form-control" placeholder="thoiGian"
                                           aria-label="Username" aria-describedby="basic-addon1" value="${thoiGianMH}" name="thoiGianMH"/>
                                </div>
                            </div>
