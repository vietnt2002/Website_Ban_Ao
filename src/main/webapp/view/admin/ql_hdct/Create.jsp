...
<main>
    <sf:form action="/hdct/store" method="POST" modelAttribute="data">
                                ...
                                <div class="input-group mb-2">
                                    <select class="form-select" id="inputGroupSelect02" name="idHoaDon"
                                        ...
                                        <c:forEach varStatus="i" items="${dsHoaDon}" var="hoaDon">
                                            <option value=${hoaDon.id}>${hoaDon.khachHang.ten} - ${hoaDon.id}</option>
                                        </c:forEach>
                                    </select>
                                ...
                                <div class="input-group mb-2">
                                    <select class="form-select" id="inputGroupSelect02" name="idSPCT"
                                        ...
                                        <c:forEach varStatus="i" items="${dsSPCT}" var="spct">
                                            <option value=${spct.id}>${spct.sanPham.ten}-${spct.mauSac.ten}/${spct.mauSac.ma
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                <div class="input-group mb-2">
                                    <input type="date" class="form-control" placeholder="ngayMuaHang"
                                              aria-label="Username" aria-describedby="basic-addon1" name="ngayMuaHang"/>
                                </div>
                            </div>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-md-12 mb-2">
                                ...
                                <div class="input-group mb-2">
                                    <input type="time" class="form-control" placeholder="thoiGian"
                                              aria-label="Username" aria-describedby="basic-addon1" name="thoiGianMH"/>
                                </div>
                            </div>
