...
<div class="shopping-cart" id="shopping-cart">
    <c:forEach items="${listSP}" varStatus="sanPhamDTO" var="sp">
        <div class="cart-item">
    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right">
                <a href="#" class="btn border" id="cart-toggle">
    ...
    <div class="row px-xl-5">
        <div class="col-lg-8 table-responsive mb-5">
            <table class="table table-bordered text-center mb-0">
                ...
                <tr>
                    <td class="align-middle"><img src="../bootstrap-shop-template/img/product-1.jpg" alt="" style="width: 50px;">${sp.ten}</td>
...
<script>
    // JavaScript to toggle the shopping cart
    ...
    cartToggle.addEventListener('click', function (e) {
        ...
        // Add click event listener to body to close shopping cart if clicked outside
    ...
    function closeCartOnClickOutside(e) {
        if (!shoppingCart.contains(e.target) && e.target !== cartToggle) {
