    ...
    <div class="row px-xl-5">
        <div class="col-lg-5 pb-5">
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner border" style="width: 450px; height: 550px; margin-left: 57px">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="../bootstrap-shop-template/img/1.jpg" alt="Image">
                    </div>
                    <div class="carousel-item">
                        <img class="w-100 h-100" src="../bootstrap-shop-template/img/2.jpg" alt="Image">
                    </div>
                    <div class="carousel-item">
                        <img class="w-100 h-100" src="../bootstrap-shop-template/img/3.jpg" alt="Image">
                    </div>
                    <div class="carousel-item">
                        <img class="w-100 h-100" src="../bootstrap-shop-template/img/4.jpg" alt="Image">
                    </div>
                </div>
