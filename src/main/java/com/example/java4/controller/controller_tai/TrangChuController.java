...
//            hoaDonCuaKH = hoaDonRepo.findByidKHAndLoaiHoaDonAndTrangThai(UserInfor.idKhachHang, HoaDonRepository.HOA_DON_ONL, HoaDonRepository.CHO_THANH_TOAN);
//
...
//
//
////        listHoaDon = (List<HoaDon>) hoaDonRepo.getHoaDonByIDKHA(UserInfor.idKhachHang);
